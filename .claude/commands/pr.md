...
5. Do not check for a changelog entry. Contributor PRs must not edit `CHANGELOG.md` — the maintainer adds the entry when merging.
6. Check whether `README.md`, `docs/*.md`, or the Gherkin specs under `tests/features/*.feature` require modification. This is usually the case when existing features have been changed, or new features have been added.
